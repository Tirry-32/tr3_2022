...
public class Quadratic {
    ...
    public static void main(String[] args) {
        ...
        double answer;  // The solution computed for the equation.
        boolean repeat;  // Set to true if the user wants to
        ...
        do {
         ...
         /* Print the solution, or an error message, if
            ...
            try {
                answer = root(A,B,C);
                System.out.println("A solution of the equation is " + answer);
            }
